...
Interview the user relentlessly about every aspect of the subject until you reach a shared understanding.
...
If a fact can be found by exploring the environment (filesystem, tools, etc.), look it up rather than asking the user. The *decisions*, though, are the user's -- put each one to the user and wait for their answer.
